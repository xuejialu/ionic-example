...
.controller('MyStocksCtrl', ['$scope', 'myStocksArrayService', 'stockDataServce', 'stockPriceCacheService', 'followStockService',
  function($scope, myStocksArrayService, stockDataServce, stockPriceCacheService, followStockService) {
    ...
    $scope.getMyStocksData = function() {
      ...
      myStocksArrayService.forEach(function(stock) {
        ...
        var promise = stockDataServce.getPriceData(stock.ticker);
...
.controller('StockCtrl', ['$scope', '$stateParams', '$window', '$ionicPopup', '$cordovaInAppBrowser', 'followStockService', 'stockDataServce', 'dateService', 'chartDataService', 'notesService', 'newsService',
  function($scope, $stateParams, $window, $ionicPopup, $cordovaInAppBrowser, followStockService, stockDataServce, dateService, chartDataService, notesService, newsService) {
    ...
    var xValueFunction = function(d, i) {
      ...
      data: 'myData',
      margin: {top: 15, right: 20, bottom: marginBottom, left: 20},
